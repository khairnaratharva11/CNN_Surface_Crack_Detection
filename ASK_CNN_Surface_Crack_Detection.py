...
plt.suptitle("ASK CNN Sample Training Images")
plt.show()
...
plt.xlabel("Epochs")
plt.ylabel("Accuracy")
plt.title("ASK CNN Training vs Validation Accuracy")
plt.legend()
plt.show()
...
plt.xlabel("Epochs")
plt.ylabel("Loss")
plt.title("ASK CNN Training vs Validation Loss")
plt.legend()
plt.show()
...
model.save("Final_ASK_Crack_Detection_Model.keras")
